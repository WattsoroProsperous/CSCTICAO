<?php //PHP ADODB document - made with PHAkt 3.7.1?>
			<div role="main" class="main">
				...
				<div class="container pt-3 mt-4">
					<div class="row mb-5">
						<div class="col-lg-7">
							<p class="text-3-5">Situé au premier étage et entière insonorisé, notre espace s'adapte à vos besoins. </p>
							<p>C'est le lieu idéal, pour le succès de vos réunion, séminaire, conférence, formation, de conseil de direction…  </p>
							<p>Dans ce centre dédié à la promotion du Sport, de la Culture et des TIC, cette salle est toute offerte pour les concerts-dédicaces, conférences de presse ou présentation grand public d'une œuvre littéraire, d’un logiciel ou encore, des partenaires d’un club sportif. </p>
							<p>Pensez succès et événement, sans oublier de nous contacter. </p>
						</div>
						<div class="col-10 col-lg-4 ms-auto pt-4 pt-5 pt-lg-4 pb-5">
							<div class="cascading-images-wrapper p-0 mt-5 mb-5">
								<div class="cascading-images position-relative">
									<img src="img/Location/Polyvalente_1.jpg" class="box-shadow-4 appear-animation" alt="" data-appear-animation="expandIn" data-appear-animation-duration="600ms" />
									<div class="position-absolute w-100" style="top: 61%; left: -20%;">
										<img src="img/Location/Polyvalente_2.jpg" class="box-shadow-4 appear-animation" width="285" alt="" data-appear-animation="expandIn" data-appear-animation-delay="300" data-appear-animation-duration="600ms" />
									</div>
								</div>
							</div>
						</div>
