<?php //PHP ADODB document - made with PHAkt 3.7.1?>
			<div role="main" class="main">
				...
				<div class="container pt-3 mt-4">
					<div class="row mb-5">
						<div class="col-lg-7">
							<p class="text-3-5">Avec ses ordinateurs de dernière génération, la salle multimédia est d’abord un espace de formation qui vous permet de découvrir les nouvelles applications et tendances en matière de Technologie de l’Information et de la Communication. </p>
							<p>A la pointe des nouvelles technologies, avec des fleurons comme SAMSUNG ou LG, la Corée du Sud est dans le peloton de tête des géants du multimédia. Pour bénéficier de l’expérience de cette puissance intellectuelle, retrouvez-nous à la salle multimédia du CSCTICAO. </p>
							<p>C’est aussi un cadre à votre disposition, pour les formations sur les nouvelles applications et nouvelles techniques en matière de maintenance électronique.</p>
						</div>
						<div class="col-10 col-lg-4 ms-auto pt-4 pt-5 pt-lg-4 pb-5">
							<div class="cascading-images-wrapper p-0 mt-5 mb-5">
								<div class="cascading-images position-relative">
									<img src="img/Location/Multimedia_1.jpg" class="box-shadow-4 appear-animation" alt="" data-appear-animation="expandIn" data-appear-animation-duration="600ms" />
									<div class="position-absolute w-100" style="top: 61%; left: -20%;">
										<img src="img/Location/Multimedia_2.jpg" class="box-shadow-4 appear-animation" width="285" alt="" data-appear-animation="expandIn" data-appear-animation-delay="300" data-appear-animation-duration="600ms" />
									</div>
								</div>
							</div>
						</div>
					...
					<div class="row row-gutter-sm pt-4 pt-sm-0">
						...
						<div class="col-md-4 col-lg-3 text-center text-md-start">
							<div class="appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="500">
								<h3 class="font-weight-semibold text-color-dark text-transform-none text-5-5 mb-3">Pour plus d'informations</h3>
								<span class="d-flex align-items-center justify-content-center justify-content-md-start pb-2 mb-3">
									...
									<a class="text-color-dark text-color-hover-primary text-decoration-none font-weight-semibold text-3-5 ms-2" href="tel:1234567890">(225) 27 22 22 27 07</a>
								</span>
								<a href="demo-business-consulting-3-contact.html" class="btn btn-dark custom-btn-style-1 font-weight-semibold btn-px-4 btn-py-2 text-3-5 mb-3" data-cursor-effect-hover="plus" data-cursor-effect-hover-color="light"><span>Nous contacter</span></a>

								<hr class="my-4">
							</div>
							<div class="appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="750">
								<h3 class="font-weight-semibold text-color-dark text-transform-none text-5-5 pt-2 mb-3">Prêt pour réserver ?</h3>
								
								<a href="index.php?cs=DemSalle" class="btn btn-primary custom-btn-style-1 font-weight-semibold btn-px-4 btn-py-2 text-3-5" data-cursor-effect-hover="plus" data-cursor-effect-hover-color="light"><span>Réserve dès maintenant</span></a>
							</div>
						</div>
					</div>
					<div class="row py-4 my-5 mb-lg-0 my-xl-5">
						<div class="col-lg-6">
							<h2 class="text-9 line-height-3 text-transform-none font-weight-semibold mb-4">Des compétences qui font une différence significative ...</h2>
							<p class="text-3-5 pb-3 mb-4">Cras a elit sit amet leo accumsan volutpat. Suspendisse hendreriast ehicula leo, vel efficitur felis ultrices non. Cras a elit sit amet leo. </p>
						</div>
						<div class="col-lg-6">
							<div class="progress-bars">
								<div class="progress-label d-flex justify-content-between">
									<span class="text-color-dark font-weight-semibold text-2">Confort pour le public </span>
								...
								<div class="progress-label d-flex justify-content-between pt-2">
									<span class="text-color-dark font-weight-semibold text-2">Toilettes pour le public </span>
									<span class="text-color-dark font-weight-semibold text-2">100%</span>								</div>
								<div class="progress progress-xs progress-no-border-radius bg-color-light-scale-1 mb-4">
								...
								<div class="progress-label d-flex justify-content-between pt-2">
									<span class="text-color-dark font-weight-semibold text-2">Sécurités pour tous</span>
									<span class="text-color-dark font-weight-semibold text-2">90%</span>
								</div>
								<div class="progress progress-xs progress-no-border-radius bg-color-light-scale-1 mb-4">
									<div class="progress-bar progress-bar-primary" data-appear-progress-animation="90%"></div>
