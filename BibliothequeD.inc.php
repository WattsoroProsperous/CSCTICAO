<?php //PHP ADODB document - made with PHAkt 3.7.1?>
			<div role="main" class="main">
				...
				<div class="container pt-3 mt-4">
					<div class="row mb-5">
						<div class="col-lg-7">
							<p class="text-3-5">Pour vos rencontres littéraires et rencontres avec la culture ivoirienne, coréenne et universelle, un seul cadre : la bibliothèque du CSCTICAO. </p>
							<p>Notre bibliothèque est un écrin de paix et de tranquillité nécessaire à la concentration et surtout à l’élévation de l’esprit. </p>
							<p>Pour préparer vos thèses, mémoires et rapports, un concentré de sérénité vous attend, pour le voyage vers d’autres univers. </p>
						</div>
						<div class="col-10 col-lg-4 ms-auto pt-4 pt-5 pt-lg-4 pb-5">
							<div class="cascading-images-wrapper p-0 mt-5 mb-5">
								<div class="cascading-images position-relative">
									<img src="img/Location/Bibliotheque_1.jpg" class="box-shadow-4 appear-animation" alt="" data-appear-animation="expandIn" data-appear-animation-duration="600ms" />
									<div class="position-absolute w-100" style="top: 61%; left: -20%;">
										<img src="img/Location/Bibliotheque_2.jpg" class="box-shadow-4 appear-animation" width="285" alt="" data-appear-animation="expandIn" data-appear-animation-delay="300" data-appear-animation-duration="600ms" />
									</div>
								</div>
							</div>
						</div>
