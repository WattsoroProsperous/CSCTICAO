<?php //PHP ADODB document - made with PHAkt 3.7.1?>
			<div role="main" class="main">
				...
				<div class="container pt-3 mt-4">
					<div class="row mb-5">
						<div class="col-lg-7">
							<p class="text-3-5">Pour vos compétitions sportives, le gymnase du CSCTICAO est à votre disposition. Sa grande capacité d’accueil, son design et surtout son niveau de modulation en fait l’espace grand public par excellence à Abidjan. D’ailleurs, il a abrité le premier championnat national de maracana connu comme la CAM TCHIN-TCHIN. </p>
							<p>Des compétitions de sports de combat s’y sont tenues, avec succès. Cette salle omnisport est une nouvelle adresse, pour vos compétitions sportives en Côte d’Ivoire. Rencontrons-nous, pour en discuter. </p>
							<p>Le gymnase du CSCTICAO est également l’espace dédié pour les rencontres grand public : foire, exposition, salon…</p>
						</div>
						<div class="col-10 col-lg-4 ms-auto pt-4 pt-5 pt-lg-4 pb-5">
							<div class="cascading-images-wrapper p-0 mt-5 mb-5">
								<div class="cascading-images position-relative">
									<img src="img/Location/Gymnase_1.jpg" class="box-shadow-4 appear-animation" alt="" data-appear-animation="expandIn" data-appear-animation-duration="600ms" />
									<div class="position-absolute w-100" style="top: 61%; left: -20%;">
										<img src="img/Location/Gymnase_2.jpg" class="box-shadow-4 appear-animation" width="285" alt="" data-appear-animation="expandIn" data-appear-animation-delay="300" data-appear-animation-duration="600ms" />
									</div>
								</div>
							</div>
						</div>
						...
						<div class="col-lg-6">
							<div class="progress-bars">
								...
								<div class="progress-label d-flex justify-content-between pt-2">
									<span class="text-color-dark font-weight-semibold text-2">Vestiaires pour les athlètes</span>
									<span class="text-color-dark font-weight-semibold text-2">100%</span>
								</div>
								<div class="progress progress-xs progress-no-border-radius bg-color-light-scale-1 mb-4">
